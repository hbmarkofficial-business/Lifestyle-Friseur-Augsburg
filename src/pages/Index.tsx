  ...
  return (
    <>
      <Helmet>
        ...
        <title>Friseursalon Augsburg | Lifestyle Friseur Augsburg</title>
        <meta
          name="description"
          content="Besuche unseren Premium Friseursalon Lifestyle Friseur Augsburg in Augsburg für erstklassige Haarschnitte, Bartpflege und individuelle Styles. Jetzt Termin buchen!"
        />
        <meta
          name="keywords"
          content="Friseursalon, Herrenfriseur, Haarschnitt, Bartpflege, Rasur, Berlin, Augsburg"
        />
        <link rel="canonical" href="https://gentlemanscut.de" />

        {/* Open Graph */}
        <meta property="og:title" content="Lifestyle Friseur Augsburg | Premium Friseursalon Berlin" />
        <meta
        ...
        <meta name="twitter:title" content="Lifestyle Friseur Augsburg | Premium Friseursalon Berlin" />
        <meta
        ...
        <script type="application/ld+json">
          {JSON.stringify({
            ...
            "@type": "Barbershop",
            "name": "Lifestyle Friseur Augsburg",
